   ...
   <div id="page" class="page">
      ...
      <main id="content" class="site-main">
         ...
         <section class="home-banner-section home-banner-slider">
            <div class="home-banner d-flex flex-wrap align-items-center" style="background-image: url(https://imgs.search.brave.com/aT7-rvYMfB3oPHWppRUkTarkrTIWthCjbD9KpOu_pnw/rs:fit:860:0:0/g:ce/aHR0cHM6Ly90aGVw/bGFuZXRkLmNvbS9p/bWFnZXMvUGxhY2Vz/LXRvLVZpc2l0LWlu/LVN3aXR6ZXJsYW5k/LUx1Z2Fuby1UaWNp/bm8tMTQyM3gxMDY3/LmpwZw);">
               <!-- <div class="overlay"></div> -->
               <div class="container">
                  <div class="banner-content text-center">
                     <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                           <h2 class="banner-title">UNLOCK YOUR WANDERLUST</h2>
            ...
            <div class="home-banner d-flex flex-wrap align-items-center" style="background-image: url(https://plus.unsplash.com/premium_photo-1697730426227-9056296a0315?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fHRyYXZlbCUyMGluZGlhfGVufDB8fDB8fHww);">
               <!-- <div class="overlay"></div> -->
               <div class="container">
                  <div class="banner-content text-center">
                     <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                           <h2 class="banner-title">JOURNEY BEYOND BOUNDARIES</h2>
                           <div class="banner-btn">
                              <!-- <a href="about.php" class="round-btn">LEARN MORE</a> -->
                           </div>
                        </div>
            ...
            <div class="home-banner d-flex flex-wrap align-items-center" style="background-image: url(https://imgs.search.brave.com/8ysbwNB4JNZJjf5hQVKVTTTNBXaRetk2zF5ZoU93DAE/rs:fit:860:0:0/g:ce/aHR0cHM6Ly90cmF2/ZWxpc2xpZmUub3Jn/L3dwLWNvbnRlbnQv/dXBsb2Fkcy9MaWZl/LW9mLVBpeC5qcGc);">
               <!-- <div class="overlay"></div> -->
               <div class="container">
                  <div class="banner-content text-center">
                     <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                           <h2 class="banner-title">Your Gateway to Global Exploration</h2>
                           <div class="banner-btn">
                              <!-- <a href="about.php" class="round-btn">LEARN MORE</a> -->
                           </div>
                        </div>
         ...
         <section class="home-destination" style="background-image: url(admin/destinationimages/1955515.jpg);">
            <div class="container">
               ...
               <div class="destination-section">
                  <div class="row">
                     ...
                     <div class="section-btn-wrap text-center">
                        <a href="destination.php" class="round-btn">More Destinations</a>
                     </div>
                  </div>
         </section>
         <!-- ***Home destination html end here*** -->
         <!-- ***Home package html start from here*** -->
         <section class="home-package" style="background-image:url(admin/destinationimages/1955515.jpg);">
            <div class="container" >
               <div class="row">
                  <div class="col-lg-8 offset-lg-2 text-sm-center">
                     <div class="section-heading">
